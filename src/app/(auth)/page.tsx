...
export default function LandingPage() {
  ...
  const opacity2 = useTransform(smoothProgress, [0.15, 0.25, 0.4, 0.5], [0, 1, 1, 0]);
  const opacity3 = useTransform(smoothProgress, [0.4, 0.5, 0.65, 0.75], [0, 1, 1, 0]);
  const opacity4 = useTransform(smoothProgress, [0.65, 0.75, 0.9, 1], [0, 1, 1, 1]);
    ...
    <div className="w-full bg-dip-100 relative">
        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <Image
              ...
              className="mr-2"
              onError={(e) => {
                e.currentTarget.src = "https://placehold.co/40x40/dip-100/white?text=UH";
              }}
            />
            <a href="/" className="text-white text-xl font-bold">UHired.ai</a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {!isLoggedIn ? (
              ...
              <>
                ...
                <Link href="/course" className="text-white/80 hover:text-white transition-colors">Courses</Link>
                <Link href="/interview" className="text-white/80 hover:text-white transition-colors">Live Video Interview</Link>
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-none z-10">
        ...
        <motion.div 
          ...
          style={{ 
            top: "calc(100vh - 6rem)",
            opacity: useTransform(smoothProgress, [0.1, 0.2, 0.3], [0, 1, 0]) 
          }}
        />
        ...
        <motion.div 
          ...
          style={{ 
            top: "calc(200vh - 6rem)",
            opacity: useTransform(smoothProgress, [0.35, 0.45, 0.55], [0, 1, 0]) 
          }}
        />
        ...
        <motion.div 
          ...
          style={{ 
            top: "calc(300vh - 6rem)",
            opacity: useTransform(smoothProgress, [0.6, 0.7, 0.8], [0, 1, 0]) 
          }}
        />
        ...
        <motion.div 
          ...
          style={{ 
            top: "calc(400vh - 6rem)",
            opacity: useTransform(smoothProgress, [0.85, 0.9, 0.95], [0, 1, 0]) 
          }}
        />
      </div>
      ...
      >
        <div className="max-w-4xl w-full text-center">
          {/* Logo */}
          <div className="mb-12">
            <h1 className="text-white text-4xl font-bold">UHired.ai</h1>
          </div>
          ...
          >
            Opportunities are for those who prepare for them. <br className="hidden sm:block" />
          ...
          >
            <div className="relative">
              <motion.div 
                ...
                animate={{ scale: hoverSignup ? 1.05 : 0, opacity: hoverSignup ? 1 : 0 }}
            ...
            <div className="relative">
              <motion.div 
                className="absolute inset-0 bg-white/10 rounded-full -z-10"
                initial={{ scale: 0, opacity: 0 }}
                animate={{ scale: hoverLogin ? 1.05 : 0, opacity: hoverLogin ? 1 : 0 }}
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              />
              <Button 
                variant="outline" 
      ...
      >
        <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-12">
          <motion.div 
            ...
            animate={{ opacity: feature1InView ? 1 : 0, x: feature1InView ? 0 : -50 }}
            transition={{ duration: 0.8 }}
          >
            <div className="bg-dip-20 w-20 h-20 rounded-full flex items-center justify-center mb-8">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-dip-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <motion.h2 
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: feature1InView ? 1 : 0, y: feature1InView ? 0 : 20 }}
            ...
            >
              Our AI generates customized interview questions based on your target role, industry, and experience level. Practice with realistic scenarios that prepare you for the real thing.
            </motion.p>
            <motion.ul 
            ...
            >
              <motion.li 
                ...
                animate={{ opacity: feature1InView ? 1 : 0, x: feature1InView ? 0 : -20 }}
                transition={{ duration: 0.3, delay: 0.5 }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-dip-20 mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                ...
                <span>Adaptive question sets based on skill sets</span>
              </motion.li>
            </motion.ul>
          </motion.div>
          <motion.div 
          ...
          >
            <div className="bg-dip-90/30 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
              <img 
                ...
                onError={(e) => {
                  e.currentTarget.src = "https://placehold.co/600x400/dip-80/white?text=AI+Practice+Interface";
                }}
              />
            </div>
          </motion.div>
      ...
      >
        <div className="max-w-6xl w-full flex flex-col md:flex-row-reverse items-center gap-12">
          <motion.div 
            className="md:w-1/2"
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: feature2InView ? 1 : 0, x: feature2InView ? 0 : 50 }}
            transition={{ duration: 0.8 }}
          >
            <div className="bg-dip-20 w-20 h-20 rounded-full flex items-center justify-center mb-8">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-dip-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <motion.h2 
              className="text-white text-4xl md:text-5xl font-bold mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: feature2InView ? 1 : 0, y: feature2InView ? 0 : 20 }}
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Video Analysis
            </motion.h2>
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.3 }}
            >
              Record your practice interviews and receive detailed feedback on your performance. Our AI analyzes your body language, speech patterns, and content to help you improve.
            </motion.p>
            <motion.ul 
              className="text-white/80 text-lg space-y-4"
              initial={{ opacity: 0 }}
            ...
            >
              <motion.li 
                className="flex items-start"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: feature2InView ? 1 : 0, x: feature2InView ? 0 : 20 }}
                transition={{ duration: 0.3, delay: 0.5 }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-dip-20 mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          >
            <div className="bg-dip-80/30 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
              <img 
                ...
                className="rounded-xl w-full"
                onError={(e) => {
                  e.currentTarget.src = "https://placehold.co/600x400/dip-70/white?text=Video+Analysis+Interface";
                }}
              />
            </div>
          </motion.div>
      ...
      >
        <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-12">
          <motion.div 
            className="md:w-1/2"
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: feature3InView ? 1 : 0, x: feature3InView ? 0 : -50 }}
            transition={{ duration: 0.8 }}
          >
            <div className="bg-dip-20 w-20 h-20 rounded-full flex items-center justify-center mb-8">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-dip-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <motion.h2 
              className="text-white text-4xl md:text-5xl font-bold mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: feature3InView ? 1 : 0, y: feature3InView ? 0 : 20 }}
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Job Matching
            </motion.h2>
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.3 }}
            >
              Discover opportunities that match your skills and experience. Our intelligent job matching system connects you with positions where you're most likely to succeed.
            </motion.p>
            <motion.ul 
              className="text-white/80 text-lg space-y-4"
              initial={{ opacity: 0 }}
            ...
            >
              <motion.li 
                className="flex items-start"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: feature3InView ? 1 : 0, x: feature3InView ? 0 : -20 }}
                transition={{ duration: 0.3, delay: 0.5 }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-dip-20 mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          >
            <div className="bg-dip-70/30 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
              <img 
                ...
                className="rounded-xl w-full"
                onError={(e) => {
                  e.currentTarget.src = "https://placehold.co/600x400/dip-60/white?text=Job+Matching+Interface";
                }}
              />
            </div>
          </motion.div>
        ...
        <div className="max-w-4xl w-full text-center relative z-10">
          ...
          >
            <motion.div 
              ...
              animate={{ x: ctaInView ? 0 : -30, opacity: ctaInView ? 1 : 0 }}
              transition={{ duration: 0.5, delay: 0.5 }}
              whileHover={{ y: -5, transition: { duration: 0.2 } }}
            >
              <p className="text-white/90 text-lg italic mb-6">
                "UHired.ai transformed my interview preparation. The AI feedback helped me identify weaknesses I didn't know I had."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-dip-20 mr-4"></div>
                <div>
                  <p className="text-white font-bold">Sarah</p>
            ...
            >
              <p className="text-white/90 text-lg italic mb-6">
                "The job matching feature connected me with opportunities I wouldn't have found otherwise. Landed my dream job in weeks!"
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-dip-20 mr-4"></div>
                <div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start">
            <div className="mb-8 md:mb-0">
              <h3 className="text-white text-2xl font-bold mb-4">UHired.ai</h3>
              <p className="max-w-xs">Your path to career success starts with the right preparation.</p>
            </div>
          ...
          <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              ...
              <a href="#" className="hover:text-white">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"></path></svg>
              </a>
              <a href="#" className="hover:text-white">
